...
func (g *Generator) format() []byte {
	...
	if err != nil {
		...
		log.Warnf("warning: internal error: invalid Go generated: %s", err)
		log.Warnf("warning: compile the package to analyze the error")
...
func (v *Value) ParseComment() (string, string) {
	...
	if !reg.MatchString(v.comment) {
		log.Errorf("constant '%s' have wrong comment format, register with 500 as default", v.originalName)
